...
CREATE TABLE consultation_reservation (
    ...
    report_json       JSON        NULL     COMMENT '상담 요약 리포트 스냅샷(AI 생성, 상담 종료 시 1회). 성공(COMPLETED)일 때만 값 있음',
    report_status     VARCHAR(20) NULL     COMMENT 'COMPLETED / FAILED / NO_MESSAGES - 상담 종료 시 결정, 종료 전엔 NULL',
